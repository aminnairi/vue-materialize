...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n//\n//\n//\n//\n//\nvar validator = function validator(value) {\n  if (value < 1) {\n    throw new Error(\"expected value to be greater or equal to 1, \".concat(value, \" given\"));\n  }\n\n  if (value > 12) {\n    throw new Error(\"expected value to be lower or equal to 12, \".concat(value, \" given\"));\n  }\n\n  return true;\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  props: {\n    small: {\n      type: Number,\n      default: 12,\n      validator: validator\n    },\n    offsetSmall: {\n      type: Number,\n      default: 0,\n      validator: validator\n    },\n    medium: {\n      type: Number,\n      default: 12,\n      validator: validator\n    },\n    offsetMedium: {\n      type: Number,\n      default: 0,\n      validator: validator\n    },\n    large: {\n      type: Number,\n      default: 12,\n      validator: validator\n    },\n    offsetLarge: {\n      type: Number,\n      default: 0,\n      validator: validator\n    },\n    extraLarge: {\n      type: Number,\n      default: 12,\n      validator: validator\n    },\n    offsetExtraLarge: {\n      type: Number,\n      default: 0,\n      validator: validator\n    }\n  },\n  computed: {\n    classes: function classes() {\n      var offsetSmall = this.offsetSmall > 0 ? \"offset-s\".concat(this.offsetSmall) : \"\";\n      var offsetMedium = this.offsetMedium > 0 ? \"offset-m\".concat(this.offsetMedium) : \"\";\n      var offsetLarge = this.offsetLarge > 0 ? \"offset-l\".concat(this.offsetLarge) : \"\";\n      var offsetExtraLarge = this.offsetExtraLarge > 0 ? \"offset-xl\".concat(this.offsetExtraLarge) : \"\";\n      return \"col s\".concat(this.small, \" \").concat(offsetSmall, \" m\").concat(this.medium, \" \").concat(offsetMedium, \" l\").concat(this.large, \" \").concat(offsetLarge, \" xl\").concat(this.extraLarge, \" \").concat(offsetExtraLarge);\n    }\n  }\n});\n\n//# sourceURL=webpack://VueMaterializeCSS/./src/components/MaterializeColumn.vue?./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/**\r\n * @example\r\n * <p v-align=\"center\">\r\n *  I am a center aligned text.\r\n * </p>\r\n */\n/* harmony default export */ __webpack_exports__[\"default\"] = (function (element, binding) {\n  return element.classList.add(\"\".concat(binding.value, \"-align\"));\n});\n\n//# sourceURL=webpack://VueMaterializeCSS/./src/directives/align.js?");
